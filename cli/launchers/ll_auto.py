...
_SYSTEM_PROMPTS: dict[str, str] = {
    "orquestrador": (
        ...
        "Quando o usuário pedir algo, analise o pedido e delegue subtarefas aos especialistas "
        "usando EXATAMENTE o formato:\n"
        "  [TAREFA para Frontend]: descrição da tarefa\n"
        "  [TAREFA para Backend]: descrição da tarefa\n"
        "  [TAREFA para Revisor]: descrição da tarefa\n"
        "  [TAREFA para Testador]: descrição da tarefa\n"
        "  [TAREFA para Documentador]: descrição da tarefa\n"
        "  [TAREFA para Executor]: descrição da tarefa\n\n"
        "Delegue APENAS para especialistas relevantes. Se conseguir responder sozinho, faça-o sem delegar. "
        "Após receber os resultados dos especialistas, consolide e apresente ao usuário."
    ),
    "frontend": (
